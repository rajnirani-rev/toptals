...
<p><?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/toptals/application/views/convert_currency.php'); ?></p>
...
<p>
  <?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/toptals/application/views/pay_chained_demo.php'); ?>
</p>
