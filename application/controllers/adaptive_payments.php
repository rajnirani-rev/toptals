...
class Adaptive_payments extends CI_Controller 
{
	...
	function Pay()
	{
		...
		$PayRequestFields = array(
								...
								'CancelURL' => 'http://toptals.devserver.com', 									// Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
								...
								'ReturnURL' => 'http://toptals.devserver.com', 									// Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
								'ReverseAllParallelPaymentsOnError' => '', 			// Whether to reverse paralel payments if an error occurs with a payment.  Values are:  TRUE, FALSE
								'SenderEmail' => 'deepak@revinfotech.com', 								// Sender's email address.  127 char max.
								'TrackingID' => '123'									// Unique ID that you specify to track the payment.  127 char max.
								);
								
		$ClientDetailsFields = array(
								'CustomerID' => '1', 								// Your ID for the sender  127 char max.
								'CustomerType' => 'org', 								// Your ID of the type of customer.  127 char max.
		...
		$Receivers = array();
		$Receiver = array(
						'Amount' => '5', 											// Required.  Amount to be paid to the receiver.
						'Email' => 'gurjeet_seller@gmail.com', 												// Receiver's email address. 127 char max.
		...
		$AccountIdentifierFields = array(
										'Email' => 'gurjeet_buyer@gmail.com', 								// Sender's email address.  127 char max.
